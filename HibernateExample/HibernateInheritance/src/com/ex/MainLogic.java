...
public class MainLogic {
	...
	public static void main(String[] args) {
	   ...
	   SuvCar suv= new SuvCar();
	   	suv.setVehicle_id(1234);
	    suv.setVehicle_name("Rav4");
	    suv.setManufacturer("Honda");
	    suv.setPrice(22234);
	    suv.setSuvcartype("SUV");
		session.save(suv);
		
		sc.setVehicle_id(1235);
	    sc.setVehicle_name("Murrano");
	    sc.setManufacturer("Nissan");
	    sc.setPrice(31024);
	    sc.setSedancartype("Sedan");
		session.save(sc);
